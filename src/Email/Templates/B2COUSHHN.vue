...
<div class="card w-full p-5 rounded-md bg-white dark:bg-gray-800">
        <h2 class="dark:text-gray-200">Universal Orlando B2C HHN Template</h2>
        <div class="wrapper-button w-full box-border mt-4">
          ...
          >
            <button style="display: flex;" v-on:click="toggleModal()">
              <img
                class="rounded-lg "
                src="https://www.universalorlando.com/webdata/k2/en/us/files/Images/600x400_EventKeyArt_UO.jpg"
                alt=""
              />
            </button>
          </div>
        ...
        <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          <div class="relative p-6 flex-auto">
            <p class="my-4 text-blueGray-500 text-lg leading-relaxed">
              That the template you have choosen was: <strong>Universal Orlando B2C HHN Template</strong>
            </p>
          </div>
          <!--footer-->
